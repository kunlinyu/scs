...
void Key (unsigned char cmd, int x, int y)
{
	...
	switch (cmd) {
		case '`':case '~':	viewtype = over;	break;
		case '1':case '!':	viewtype = car;		break;
		case '2':case '@':	viewtype = bird;	break;
		case '3':case '#':	viewtype = birdf;	break;
		case '4':case '$':	viewtype = hard;	break;
		case '5':case '%':	viewtype = back;	break;
		case '6':case '^':	viewtype = overf;	break;
		case '7':case '&':	viewtype = soft;	break;
		case '0':case ')':	viewtype = mouse;	break;
